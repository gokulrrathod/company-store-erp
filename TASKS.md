...
Moving to **Design Input Sheet** next — the file-upload capability this needed now exists, so it gets built with real attachments from the start instead of retrofitted.
